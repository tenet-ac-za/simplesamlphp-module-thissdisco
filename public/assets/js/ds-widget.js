...
jQuery(function ($) {
    $.widget("thiss.discovery_client", {
            ...
            if (!$.isFunction(obj.options.search)) {
                ...
                obj.options.search = function (text, callback) {
                  obj.ac.forEach(ab => ab.abort())
                    ...
                    thiss.json_mdq_search(text, obj.options.search_url, obj.options.entityID, obj.options.trustProfile, {signal: this_ab.signal})
                        .then(data => {
        ...
        _update: function () {
            let obj = this;
            obj._ds = new thiss.DiscoveryService(obj.options.mdq, obj.options.persistence,
